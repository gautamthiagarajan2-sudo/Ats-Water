    ...
    <div className="max-w-7xl mx-auto px-6 lg:px-12">
      <div className="grid lg:grid-cols-2 gap-32 items-center mb-32">
        <div className="relative">
          ...
          >
            <div className="text-teal-400 font-black text-5xl mb-4">15+</div>
            <h5 className="font-black text-white text-2xl leading-tight mb-4 uppercase">Years of <br /> Engineering</h5>
            <p className="text-slate-400 font-medium leading-relaxed text-sm italic">
              "Providing ultimate solutions and professional technical support in the field of Water & Wastewater Treatment using advanced technologies."
            </p>
          </motion.div>
        </div>
        ...
        <div>
          ...
          <p className="text-slate-500 leading-relaxed mb-12 text-xl font-medium">
            ATS Water Technologies specializes in complete turnkey solutions—including design, engineering, supply, erection, commissioning, and plant operation.
          </p>
          ...
          <div className="space-y-12">
             ...
             <div className="flex items-start space-x-6 group">
                ...
                <div>
                   ...
                   <p className="text-slate-500 text-sm font-medium">To provide affordable solutions for pollution control and create a sustainable environment.</p>
                </div>
             </div>
          </div>
        </div>
